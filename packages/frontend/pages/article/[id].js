...
export default function ArtivleId({ article }) {
  ...
  return (
    <div>
      ...
      <Header/>
      <section className={s.pArticle}>
        <div className="sInnerSlim">
          <div className={s.articleHeader}>
            <ul className={s.tagList}>
              <li className={s.tagItem}>
                <p className={s.tagTxt}>エンジニアリング</p>
              </li>
              <li className={s.tagItem}>
                <p className={s.tagTxt}>開発</p>
              </li>
            </ul>
            <h1 className={s.ttl}>{article.title}</h1>
            <p className={s.description}>{article.description}</p>
            <div className={s.dates}>
                      <p className={s.createDate}>
