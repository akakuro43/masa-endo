        ...
        <div className="pj-innerSlim">
          <div className={`relative`}>
            ...
            <div className={`flex mt-20px`}>
                      <p className={`text-14px font-regular flex items-center opacity-60 text-gray`}>
                      ...
                      <p className={`text-14px font-regular flex items-center opacity-60 text-gray ml-3`}>
                      <svg className={`mr-4px`} width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={`mt-56px`}>
            <div className={`w-full h-80px relative z-20 rounded-md bg-dark3`}>
