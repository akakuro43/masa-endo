  ...
  return (
    <div>
      ...
      <section className={`${s.pKeyVisual} w-full relative`}>
        <div className={`p-fitParent z-10 flex flex-col justify-center`}>
          <h1 className={`${s.siteName} text-center font-bold text-off-white`}>Masa-Endo</h1>
          <p className={`${s.siteTheme} text-center font-medium opacity-80`}>Engineering, Tech, PdM</p>
        </div>
        <div className={`${s.bg} p-fitParent z-0`}></div>
      </section>
            ...
            <li className={`${s.articleItem} relative`} key={article.id}>
              <Link href={`article/${article.id}`}>
                ...
                <div className={s.contents}>
                  ...
                  <p className={`${s.description} font-medium opacity-70`}>{article.description}</p>
                </div>
                </a>
              </Link>
              <div className={`flex mt-5`}>
                    <p className={`${s.createDate} font-regular flex items-center opacity-70`}>
                    ...
                    <p className={`${s.updateDate} font-regular flex items-center opacity-70 ml-3`}>
                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
