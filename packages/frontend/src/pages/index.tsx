  ...
  return (
    <div>
      ...
      <section className={`${s.pKeyVisual} w-full relative h-360px`}>
        <div className={`inset-0px absolute z-10 flex flex-col justify-center`}>
        ...
        <div className={`${s.bg} inset-0px absolute z-0`}></div>
      </section>
           ...
           {article.map(article => (
            <li className={`${s.articleItem} w-320px relative`} key={article.id}>
              ...
              <div className={`flex mt-20px`}>
                    <p className={`text-13px font-en font-regular flex items-center opacity-70 text-gray`}>
                    ...
                    <p className={`text-13px font-en font-regular flex items-center opacity-70 ml-3 text-gray`}>
                    <svg className={`mr-4px`} width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
